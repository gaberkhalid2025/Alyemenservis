...
data class AdminSettingsEntity(
    ...
    val footerItemsOrder: String = "INFO,TEXT,VERSION",
    ...
    val disableBookingFirewall: Boolean = false,
    ...
    val bannerContent: String = "🔥 خصومات حصرية بنسبة ٢٠٪ على جميع أعمال الصيانة الكهربائية والمنزلية في صنعاء هذا الأسبوع!",
