...
class UserAuthIntegrationTest {
    ...
    @Test
    fun `test user registration success flow`() = runTest {
    ...
    @Test
    fun `test user registration fails when email already exists`() = runTest {
    ...
    @Test
    fun `test user registration fails with weak password`() = runTest {
    ...
    @Test
    fun `test user login success flow`() = runTest {
    ...
    @Test
    fun `test user login fails with invalid credentials`() = runTest {
        val email = "user@yemen.services.com"
    ...
    @Test
    fun `test user login fails with non existent user`() = runTest {
    ...
    @Test
    fun `test simulated network error during authentication`() = runTest {
        val email = "user@yemen.services.com"
        val password = "ValidPassword123"
