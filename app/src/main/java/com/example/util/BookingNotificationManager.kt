 ...
 * إدارة إرسال الإشعارات الشاملة لجميع أطراف الحجز (العميل، الفني، الأدمن) محلياً وسحابياً.
 */
class BookingNotificationManager(private val context: Context) {
    ...
    companion object {
        ...
        private const val CHANNEL_NAME = "إشعارات الحجوزات والخدمات"
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "تنبيهات حالة الحجوزات والمواعيد"
    ...
    /**
     * إظهار إشعار محلي على جهاز المستخدم
     */
    private fun showLocalNotification(title: String, body: String, notificationId: Int = (1000..9999).random()) {
        try {
     ...
     */
    private fun persistNotificationToCloud(
        targetUserId: String,
    ...
    /**
     * 1. إشعار عند إنشاء حجز جديد (للفني والأدمن)
     */
    ...
    /**
     * 2. إشعار عند قبول الحجز (للمستخدم والأدمن)
     */
    ...
    /**
     * 3. إشعار عند رفض الحجز (للمستخدم والأدمن)
     */
    ...
    /**
     * 4. إشعار عند بدء التنفيذ (للمستخدم والأدمن)
     */
    ...
    /**
     * 5. إشعار عند اكتمال الحجز (للمستخدم والفني والأدمن)
     */
    ...
    /**
     * 6. إشعار عند إلغاء الحجز (للطرفين والأدمن)
     */
    ...
    /**
     * 7 & 8. تذكير بموعد الحجز (24 ساعة / 1 ساعة)
     */
