...
fun AdminColorsPanel(
    ...
    with(state) {
        Column(
            ...
            Text("🎨 تخصيص الثيمات والألوان والمظهر العام", fontSize = 14.sp, fontWeight = FontWeight.Bold, color = themeColors.accent)
            Text("تحكم في ألوان التطبيق والسمات البصرية.", color = Color.LightGray, fontSize = 11.sp)
        }
    }
}
