...
fun AdminVipPanel(
    ...
    with(state) {
        Column(
            ...
            Text("🌟 إدارة العضويات المميزة VIP والتمييز الذهبي", fontSize = 14.sp, fontWeight = FontWeight.Bold, color = themeColors.accent)
            Text("إدارة شارات التميز والعضويات الذهبية للمزودين والمحلات.", color = Color.LightGray, fontSize = 11.sp)
        }
    }
}
